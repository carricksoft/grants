...
import scot.carricksoftware.grants.controllers.places.countries.CountryFormControllerImpl;
...
public class RegionFormControllerTest {
    ...
    public void getNewRegionTest() {
        ...
        assertEquals("regionCommand", stringCaptor.getValue());
        assertEquals("RegionCommandImpl", objectCaptor.getValue().getClass().getSimpleName());
    }
