...
class CensusEntryFormControllerITest {
    ...
    @BeforeEach
    void setUp() {
        censusEntryController = new CensusEntryFormControllerImpl(censusEntryServiceMock, censusServiceMock,
                censusEntryCommandConverterMock,censusEntryConverterMock,personServiceMock,capitalisationMock);
