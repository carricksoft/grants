...
class DocumentImageConverterTest {

    private DocumentImageConverter converter;

    @BeforeEach
    void setUp() {
        converter = new DocumentImageConverterImpl();
    }
    ...
    void covertTest() {
        ...
        DocumentImage source = new DocumentImage();
        ...
        DocumentImageCommand target = converter.convert(source);
