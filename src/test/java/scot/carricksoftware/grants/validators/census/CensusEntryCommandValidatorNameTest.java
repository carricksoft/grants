...
class CensusEntryCommandValidatorNameTest {
    ...
    @Test
    public void nameMinimumSizeIsAllowedTest() {
    ...
    @Test
    public void nameMaximumSizeIsAllowedTest() {
    ...
    @Test
    public void nameGreaterThanMaximumSizeIsRejectedTest() {
    ...
    @Test
    public void nameSmallerThanMinimumSizeIsRejectedTest() {
        ArgumentCaptor<String> stringArgumentCaptor = ArgumentCaptor.forClass(String.class);
        ArgumentCaptor<Object[]> objectArgumentCaptor = ArgumentCaptor.forClass(Object[].class);
